...
export class ContactService {
  ...
  filteredContactsSubject = new Subject<Contact[]>();
  contacts: Contact[] = [
    {
  ...
  public getContacts(filterBy = null) {
    ...
    this.filteredContactsSubject.next(this._sort(contactsToReturn));
  }
  ...
  public deleteContact(id: string) {
    ...
    this.filteredContactsSubject.next(this.contacts);
  }
